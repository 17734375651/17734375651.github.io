...
- `accounting` is priced at `¥999 / 账号 / 年`, and one account means one enterprise ledger subject (`一个账号对应一个企业账套主体`).
