  ...
  },
  {
    ...
    copy: {
      ...
      serviceParagraphs: [
        ...
        '标签印刷排版计划为 ¥199 / 年、脱敏展示包可下载；方寸有序胀色裁切为 ¥799 / 年、已提供核验客户端与脱敏展示包；方寸 PDF 配印助手为 ¥599 / 年、脱敏展示包可下载。',
      ],
      ...
      downloadParagraphs: [
        '方寸有序胀色裁切 1.2.11 提供 Windows x86 公开包、发布清单、发布记录与 SHA-256 校验文件，下载前可逐项核对。',
        '三款正式软件的脱敏展示包均可直接下载；标签印刷排版计划与方寸 PDF 配印助手的客户端仍在完成发布确认。',
      ],
