...
export const LEGAL_PAGES = [
  ...
  },
  {
    ...
    status: 'public-boundary',
    scope: '说明四款正式软件、个性化定制以及当前公开的下载与授权范围。',
    copy: {
      topNotice: '本页汇总当前公开的价格、体验、下载与授权范围；具体购买和定制内容以双方确认的信息为准。',
      serviceHeading: '一、产品与体验状态',
      serviceParagraphs: [
        '标签印刷排版计划、方寸有序胀色裁切、方寸有序多尺寸胀色裁切、方寸 PDF 配印助手四款正式软件可分别购买、独立使用；每台电脑首次可体验 1 小时。',
        '标签印刷排版计划为 ¥199 / 年、方寸有序胀色裁切为 ¥799 / 年、方寸有序多尺寸胀色裁切为 ¥1499 / 年、方寸 PDF 配印助手为 ¥599 / 年；四款均已提供可核验客户端。',
      ],
      ...
      downloadParagraphs: [
        '标签印刷排版计划与方寸 PDF 配印助手提供 Windows 10/11 x64、Windows 7 x64 公开包；方寸有序胀色裁切 1.2.11 提供 Windows x86 公开包；方寸有序多尺寸胀色裁切 0.9.0 提供 Windows x64 公开包。',
        '四款正式软件的客户端、公开发布清单、发布记录与 SHA-256 校验文件均可直接下载。当前未进行数字签名的客户端请在下载后核对 SHA-256。',
      ],
