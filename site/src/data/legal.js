...
export const LEGAL_PAGES = [
  ...
  },
  {
    ...
    status: 'public-boundary',
    scope: '说明七款正式软件、个性化定制以及当前公开的下载与授权范围。',
    copy: {
      topNotice: '本页汇总当前公开的价格、体验、下载与授权范围；具体购买和定制内容以双方确认的信息为准。',
      serviceHeading: '一、产品与体验状态',
      serviceParagraphs: [
        '七款 Windows 软件可分别购买、独立使用。首次启动无需申请，按本机受保护时间自动体验 30 天；在正常系统状态下每台设备每款产品一次。',
        '方寸有序记账软件为 ¥999 / 账号 / 年；一个记账账号对应一个企业账套主体。',
        '标签印刷排版计划 ¥199 / 年、方寸有序胀色裁切 ¥799 / 年、方寸有序多尺寸胀色裁切 ¥1499 / 年、方寸 PDF 配印助手 ¥599 / 年；方寸有序条码匹配与方寸有序颜色尺寸提取的价格按需求咨询。七款产品均提供可核验的公开客户端与发布资料。',
      ],
      ...
      downloadParagraphs: [
        '标签印刷排版计划、方寸 PDF 配印助手、方寸有序记账软件、方寸有序条码匹配与方寸有序颜色尺寸提取提供 Windows x64 公开包；方寸有序胀色裁切 1.2.12 提供 Windows 10/11（x86 客户端，兼容 x86/x64）公开包；方寸有序多尺寸胀色裁切 0.10.0 提供 Windows x64 公开包。',
        '七款正式软件的客户端、公开发布清单、发布记录与 SHA-256 校验文件均可直接下载。当前未进行数字签名的客户端请在下载后核对 SHA-256。',
      ],
