...
export const LEGAL_PAGES = [
  ...
  },
  {
    ...
    status: 'public-boundary',
    scope: '说明三款正式软件、个性化定制以及当前公开的下载与授权范围。',
    copy: {
      ...
      serviceParagraphs: [
        ...
        '标签印刷排版计划为 ¥199 / 年、方寸有序胀色裁切为 ¥799 / 年、方寸 PDF 配印助手为 ¥599 / 年；三款均已提供可核验客户端与脱敏展示包。',
      ],
      ...
      downloadParagraphs: [
        '标签印刷排版计划与方寸 PDF 配印助手提供 Windows 10/11 x64、Windows 7 x64 公开包；方寸有序胀色裁切 1.2.11 提供 Windows x86 公开包。',
        '三款正式软件的客户端、公开发布清单、发布记录、SHA-256 校验文件与脱敏展示包均可直接下载。标签与 PDF 客户端当前未进行数字签名，下载后请核对 SHA-256。',
      ],
