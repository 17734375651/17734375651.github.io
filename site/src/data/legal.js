...
export const LEGAL_PAGES = [
  ...
  },
  {
    ...
    copy: {
      ...
      downloadParagraphs: [
        '标签印刷排版计划、方寸 PDF 配印助手、方寸打包计算器与方寸有序记账软件提供 Windows 10/11 x64 公开包；方寸有序胀色裁切 1.2.12 提供 Windows 10/11（x86 客户端，兼容 x86/x64）公开包；方寸有序多尺寸胀色裁切 0.10.0 提供 Windows x64 公开包。',
