...
export const SITE = {
  ...
  "licenseClaim": "正式软件按各自授权说明执行；客户端内查看体验、购买和激活状态。",
  "trialRibbon": "每台电脑首次免费体验 1 小时",
  "trialScope": "一小时体验适用于四款印前工具；打包计算器与记账软件按各自年度授权说明。",
  "privacyClaims": [
    "本地优先运行",
    "客户资料不上传官网",
    "官网不接收客户文件",
...
export const SEO_ROUTES = [
  ...
  },
  {
    ...
    "coreStaticBody": [
      ...
      "年授权 199 元；Windows 10/11 与 Windows 7 x64 客户端可下载；每台电脑首次免费体验 1 小时。"
    ],
    "verifiedFacts": {
      "status": "正式销售 · 已验证下载",
      "price": "199 元/年",
      ...
      "boundary": "官网提供已核验的 Windows x64 客户端；客户端首次启动进入授权激活界面，客户资料不上传官网。",
  ...
  },
  {
    ...
    "coreStaticBody": [
      ...
      "年授权 599 元；Windows 10/11 与 Windows 7 x64 客户端可下载；每台电脑首次免费体验 1 小时。"
    ],
    "verifiedFacts": {
      "status": "正式销售 · 已验证下载",
      "price": "599 元/年",
      ...
      "boundary": "官网提供已核验的 Windows x64 客户端；客户端首次启动进入授权激活界面，官网不接收客户文件上传。",
  ...
  },
  {
    ...
    "coreStaticBody": [
      ...
      "年授权 499 元；Windows 10/11 x64 客户端可下载；按产品年度授权说明使用。"
    ],
    "verifiedFacts": {
      "status": "正式销售 · 已验证下载",
      "price": "499 元/年",
      ...
      "boundary": "官网提供已核验的 Windows 10/11 x64 客户端；业务资料在本地处理，具体年度授权以产品页说明为准。",
  ...
  },
  {
    ...
    "coreStaticBody": [
      ...
      "¥999 / 账号 / 年；Windows 10/11 与 Windows 7 x64 客户端可下载；一个账号对应一个企业账套主体。"
    ],
    "verifiedFacts": {
      "status": "正式销售 · 已验证下载",
      "price": "999 元/账号/年",
      ...
      "boundary": "按账号年度授权；一个账号对应一个企业账套主体，可在支持的 Windows 客户端上使用；具体授权规则以产品页说明为准。",
  ...
  },
  {
    ...
    "coreStaticBody": [
      ...
      "定制设计及首个可用版本 499 元起；正式版年费根据功能复杂度报价。四款印前工具的一小时体验与两款新增软件的年度授权规则见各产品页；定制项目按需求沟通。"
    ],
    "verifiedFacts": {
      "requiredFields": [
        "业务类型",
