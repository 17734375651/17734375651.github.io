...
export const SITE = {
  ...
  "productClaim": "三款正式软件可分别购买、独立使用；客户端、脱敏展示包与发布校验文件均可直接下载。",
...
export const SEO_ROUTES = [
  {
    ...
    "coreStaticBody": [
      ...
      "三款正式软件：标签印刷排版计划、方寸有序胀色裁切、方寸 PDF 配印助手。三款客户端、脱敏展示包与发布校验文件均可直接下载。"
    ],
    "verifiedFacts": {
      "audience": [
        "图文店",
  ...
  },
  {
    ...
    "coreStaticBody": [
      ...
      "年授权 199 元；Windows 10/11 与 Windows 7 x64 客户端及脱敏展示包可下载；每台电脑首次免费体验 1 小时。"
    ],
    "verifiedFacts": {
      "status": "正式销售 · 已验证下载",
      "price": "199 元/年",
  ...
  },
  {
    ...
    "coreStaticBody": [
      ...
      "年授权 599 元；Windows 10/11 与 Windows 7 x64 客户端及脱敏展示包可下载；每台电脑首次免费体验 1 小时。"
    ],
    "verifiedFacts": {
      "status": "正式销售 · 已验证下载",
      "price": "599 元/年",
