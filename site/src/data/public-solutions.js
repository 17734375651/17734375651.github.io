...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    audience: '适合希望把商品、客户、采购、销售、库存和审批流程梳理得更清楚的中小企业。',
    currentPainPoints: [
      '单据、库存、审批与待办分散，衔接过程不够清楚。',
      '商品与客户资料需要重复整理。',
      '不同角色的字段、审批与可见范围需要统一。',
    ],
    commonInputs: [
    ...
    keyProcessing: [
      ...
      '衔接采购、销售、库存与待办流程。',
      '按角色控制字段、审批与可见范围。',
      '先整理实际规则、资料与交付结果，再预约确认。',
    ],
    verifiableOutputs: [
      '待办工作台。',
      '库存事件。',
      '按角色可见的经营视图。',
      '按需求确认后的可执行、可复核、可追踪结果。',
    ],
    relatedProducts: [
      {
        productId: 'erp',
        name: '方寸有序 ERP',
        relationship: '与商品和客户资料、采购销售单据、角色与审批规则，以及订单、库存、权限流转场景相符；当前提供预约体验。',
        matchOn: ['商品与客户资料', '采购销售单据', '角色与审批规则'],
      },
    ],
    prefilledCustomizationParams: {
      ...requirementDefaults,
