...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    keyProcessing: [
      '先梳理当前最耗时的环节与可提供资料。',
      '把进货、销售、收付款与财务整理转成明确规则。',
      '根据商品、箱型与快递计费规则比较打包方案和成本。',
      '在关键步骤保留人工复核与确认入口。',
      '按实际流程确认可执行、可复核的交付形式。',
    ],
    verifiableOutputs: [
    ...
    relatedProducts: [
      {
        ...
        name: '方寸有序记账软件',
        relationship: '适合把进货、销售、收付款与财务报表整理到一个企业账套主体中；一个账号对应一个企业账套主体。',
        matchOn: ['进货与销售记录', '收付款与财务资料', '一个企业账套主体'],
      },
      {
        productId: 'packing',
        name: '方寸打包计算器',
        relationship: '适合根据商品、箱型与快递计费规则比较装箱方案和运输成本。',
        matchOn: ['商品资料', '箱型参数', '快递计费规则'],
      },
    ],
    prefilledCustomizationParams: {
      ...requirementDefaults,
      fields: {
        scene: '中小企业',
        slowProcess: '进货、销售、收付款、财务整理或打包计费（请改成当前最耗时环节）',
        inputs: 'Excel 或 CSV；进货、销售、收付款与财务资料；商品、箱型与快递计费规则（请按实际资料修改）',
        expected: '企业账套报表、装箱与费用方案、异常提示或复核明细（请按实际交付修改）',
        constraints: requirementDefaults.fields.constraints,
      },
    },
  },
